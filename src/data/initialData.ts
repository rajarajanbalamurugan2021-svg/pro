...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    firstName: 'RAJARAJAN',
    lastName: 'B',
    email: 'rajarajan2008@ckcet.ac.in',
    officialEmail: 'rajarajan2008@ckcet.ac.in',
    role: 'student',
    ...
    rollNumber: '36',
    registerNo: '420725106036',
    phone: '9994454494',
    whatsappNumber: '9994454494',
    dateOfBirth: '04-09-2008',
    gender: 'Male',
    religion: 'Hindu',
    communalCategory: 'MBC',
    bloodGroup: 'O+VE',
    country: 'India',
    state: 'Tamil Nadu',
    district: 'Cuddalore',
    cityVillage: '',
    address: '18, DURGA NAGAR, MANAKUPPAM, PACHCHYAKUPPAM, CUDDALORE',
    streetArea: '',
    pinCode: '',
    motherTongue: '',
    nationality: 'Indian',
    ...
    section: 'A',
    batch: '2025-2029',
    parentEmail: 'parent.rajarajan@gmail.com',
    parentPhone: '9994454494',
    skills: ['React.js', 'Node.js', 'Python', 'Embedded Systems', 'TypeScript', 'Tailwind CSS'],
    interests: ['Electronics', 'Communication Systems', 'Embedded AI'],
    projectsCompleted: 3,
    githubProfile: 'https://github.com/rajarajan-dev'
  },
  {
    id: 'u-student-2',
    name: 'Sophia Patel',
